...
![We can also `group_by()` more than one variable so whatever we do after this, there will be a row for each combination of values of those variables.](dplyr_art/groupby_complex.png){width=50%}
